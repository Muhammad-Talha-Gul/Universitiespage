...
class Guide extends Model
{
    ...
    protected $fillable = [
        'user_id','guide_type','title','sm_question','sm_answer','review_detail','rating_count','review_count','avg_review_value','sub_title','university_id','subject_id','short_description','description','image','image_ext','is_active','views','ip','slug','is_featured','sort_order','seo'
    ];
