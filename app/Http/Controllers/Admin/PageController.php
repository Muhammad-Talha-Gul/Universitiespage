...
class PageController extends Controller
{
    ...
    public function freeConsulationDelete($id){
        $freeConsulation = FreeConsulation::where('id',$id)->first();
        $freeConsulation->delete();
        return response()->json();

    } 
    public function freeConsulation(){
       $freeCon = FreeConsulation::get();
       return view('admin.free_consulation',compact('freeCon'));
    }
    
    public function apply_now(){
       $freeCon = ApplyNow::get();
       return view('admin.apply_now',compact('freeCon'));
    }  
    
    public function applyNowDelete($id){
        $freeConsulation = ApplyNow::where('id',$id)->first();
        $freeConsulation->delete();
        return response()->json();
