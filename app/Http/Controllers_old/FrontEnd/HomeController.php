...
class HomeController extends Controller
{
    ...
    public function sendmail(Request $request)
    {
        ...
        Notifications::create([
            ...
            'mail_id'=>$mail['id'],
            'meta'=>'New Contact Email',
            'is_read'=>0,
        ]);
        try{
            Mail::send('emails.contact', $data, function ($m) use($to) {
                $m->from('noreply@universitiespage.com.pk', 'University Pages');
                $m->to($to)->subject('Contact Email from University Pages');
            });
        }catch(\Exception $e){
            //
        }
    ...
    public function dashboard()
    {
        ...
        if(Auth::user()->user_type == 'student'){
           ...
           return view('frontend.student.dashboard', compact('wishlist','notifications','app'));
            ...
            return view('frontend.consultant.dashboard',['user'=>$user,'consultant'=>$consultant]);
        }
    ...
    public function courseDetail($id){
        ...
        return view('frontend.course_detail',['data'=>$data]);
    }
