            ...
            <div class="">
                ...
                <div class="card-box">
                    ...
                    <p class="text-muted m-b-30 font-13">
                        Use  <code>&lt;i class="glyphicon glyphicon-glass"&gt;&lt;/i&gt;</code>. for Editor.
                    </p>

                    <div class="row icon-list-demo icons-container">
...
<script src="{{asset("assets_backend/pages/jquery.icons.js")}}"></script>
@endsection