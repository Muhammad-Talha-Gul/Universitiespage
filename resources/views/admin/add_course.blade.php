                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text" class="form-control" name="name" placeholder="Course Name" value="{{ old('name') }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="number" class="form-control" value="{{ old('name') }}" name="duration_qty" placeholder="Year/Months in No." required>
                                                            </div>
                                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text" class="form-control" name="yearly_fee" placeholder="Yearly Fee" value="{{ old('yearly_fee') }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text" class="form-control tags" name="languages" value="{{ old('languages') }}" placeholder="Teaching Languages" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
