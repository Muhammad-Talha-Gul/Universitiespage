                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="title" placeholder="Enter Job Title" value="{{$job->title}}">
                                                            @if ($errors->has('title'))
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-select form-control" name="job_type" aria-label="Default select example">
                                                                ...
                                                                <option value="Part Time" {{$job->job_type == 'Part Time' ? selected : ''}}>Prt Time</option>
                                                                <option value="Contract" {{$job->job_type == 'Contract' ? selected : ''}}>Contract Based</option>
                                                            </select>
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="city" placeholder="Enter City" value="{{$job->city}}">
                                                            @if ($errors->has('city'))
                                                            <span class="help-block">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="province" placeholder="Enter Province" value="{{$job->province}}">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="country" placeholder="Enter Country" value="{{$job->country}}">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                                            ...
                                                            <select class="form-select form-control" name="site_based" aria-label="Default select example">
                                                                ...
                                                                <option value="onsite" {{$job->site_based == 'onsite' ? selected : ''}}>Onsite</option>
                                                                <option value="remote" {{$job->site_based == 'remote' ? selected : ''}}>Remote</option>
                                                            </select>
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                        <div class="form-group tag-input-main">
                                                            ...
                                                            <input type="text" name="skills" class="form-control tabg-input" placeholder="Enter Skills Tag With Comma and Enter" style="height: 100%; width:100%;" value="{{$job->skills}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                        <div class="form-group">
                                                            <label class="control-label" for="">Experience</label>
                                                            <input type="text" class="form-control" name="experience" placeholder="Enter Experience" value="{{$job->experience}}">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12">
                                                        <div class="form-group{{ $errors->has('requirements') ? ' has-error' : '' }}">
                                                            ...
                                                            <textarea class="form-control textarea-editor" rows="10" cols="12" name="requirements">{{ $job->requirements }}</textarea>
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12">
                                                        <div class="form-group{{ $errors->has('responsibilities') ? ' has-error' : '' }}">
                                                            ...
                                                            <textarea class="form-control textarea-editor" rows="10" cols="12" name="responsibilities">{{ $job->responsibilities }}</textarea>
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12">
                                                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                                            ...
                                                            <textarea class="form-control textarea-editor" rows="10" cols="12" name="description" placeholder="Enter Job Details">{{ $job->description }}</textarea>
