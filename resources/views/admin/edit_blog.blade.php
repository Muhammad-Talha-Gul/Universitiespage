...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="">
                            <div class="col-md-6">
                                <div class="form-group m-b-20">
                                    ...
                                    <input type="text" class="form-control" id="blog-title" name="title" placeholder="Enter title" value="{{$data['title']}}" required>
                                </div>
                                <div class="form-group m-b-20">
                                ...
                                <div class="form-group">
                                    <label>Views</label>
                                    <input type="number" class="form-control" name="views" value="{{$data['views']}}" placeholder="Number of views" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="short_description" rows="9" required placeholder="Enter short description">{{$data['short_description']}}</textarea>
                                </div>
                            </div>
                            <div class="clearfix"></div>   
            ...
            <form action="{{route('blog.destroy',$data['id'])}}" method="POST" id="delete-form">
