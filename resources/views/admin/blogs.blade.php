	...
	<div class="row">
		<div class="col-md-12">
			<div class="card-box table-responsive">
                ...
                <a href="{{route('blog.create')}}" class="btn btn-primary btn-md pull-right" style="margin-bottom: 10px;margin-right:10px;">Add Post</a>
                @endif
                ...
                <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th>Active</th>
                        <th>Created at</th>
                        @if(check_access(Auth::user()->id,'blog','_edit')==1)
                        <th>Action</th>
                        @endif
                    </tr>
                    </thead>
                	...
                	<tr>
                        ...
                        <td>{{$value->title}}/ <a href="{{url($value->slug)}}" target="_blank"><i class="fa fa-eye"></i></a></td>
                        ...
                        @if(check_access(Auth::user()->id,'blog','_edit')==1)
                		<td><a href="{{route('blog.edit',$value->id)}}" class="btn btn-warning btn-md">Edit</a></td>
                        @endif
                	</tr>
                	@endforeach
