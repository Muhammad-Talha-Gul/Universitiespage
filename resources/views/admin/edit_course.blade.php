...
@endsection
@section('content')
@if(check_access(Auth::user()->id,'course','_edit')==1)
<div class="container">
    <div class="row">
        <div class="col-xs-12">
    ...
    <div class="row">
        <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text" class="form-control" name="name" placeholder="Course Name" value="{{ $data->name }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="number" class="form-control" name="duration_qty" placeholder="Year/Months in No." value="{{ $data->duration_qty }}" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <select name="duration_type" class="form-control" required>
                                                                    <option @if($data->duration_type == 'Year') selected @endif value="Year">Year</option>
                                                                    <option @if($data->duration_type == 'Months') selected @endif value="Months">Months</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                @if(Auth::user()->user_type == 'university')
                                                                    <input type="hidden" value="{{Auth::user()->university_detail->id}}" name="university_id">
                                                                    <input type="text" class="form-control" readonly value="{{Auth::user()->university_detail->name}}">
                                                                @else
                                                                    <select name="university_id" class="form-control select2" required>
                                                                        @foreach($universities as $university)
                                                                            <option value="{{$university->id}}" @if($data->university_id == $university->id) selected @endif>{{$university->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                @endif
                                                            </div>
                                                            ...
                                                            <div class="col-md-11">
                                                                <select class="form-control select2" name="qualification" required>
                                                                    @foreach(qualification() as $edu)
                                                                        <option value="{{$edu->id}}" @if($data->qualification == $edu->id) selected @endif>{{$edu->title}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text" class="form-control datepicker-autoclose" name="starting_date" placeholder="Starting Date" value="{{ $data->starting_date }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                   ...
                                                   {{--  <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text" class="form-control datepicker-autoclose" name="deadline" placeholder="Deadline" value="{{ $data->deadline }}">
                                                            </div>
                                                        </div>
                                                    </div> --}}
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text"  class="form-control" name="yearly_fee" placeholder="Yearly Fee" value="{{ $data->yearly_fee }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="number" class="form-control" name="application_fee" placeholder="Appplication Fee" value="{{ $data->application_fee }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text" class="form-control tags" name="languages" value="{{ $data->languages }}" placeholder="Teaching Languages" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;clear: both;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="number" class="form-control" name="sort_order" placeholder="Yearly Fee" value="{{ $data->sort_order }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="p-20">
                                            <div class="">
                                                <div class="form-group col-sm-10">
                                                    <label>About</label>
                                                    <textarea class="form-control" name="about" placeholder="about">{!! $data->about !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-20">
                                            <div class="">
                                                <div class="form-group col-sm-10">
                                                    ...
                                                    <textarea class="summernote" name="entry_requirments">{!! $data->entry_requirments !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="">
                                                <div class="">
                                                    <div class="form-group col-sm-10">
                                                        ...
                                                        <textarea class="summernote" name="curriculum">{!! $data->curriculum !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="card-box table-responsive">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="checkbox checkbox-primary">
                                    <input type="checkbox" name="active" value="1" @if($data->active == 1) checked @endif>
                                    <label>Active</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <div class="checkbox checkbox-primary">
                                <input type="checkbox" name="scholarship" @if($data->scholarship == 1) checked @endif value="1" >
            ...
            <form action="{{route('course.destroy',$data['id'])}}" method="POST" id="delete-form-{{$data->id}}">
