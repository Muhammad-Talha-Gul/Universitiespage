            ...
            <div class="item">
              <a href="{{url($blog->slug)}}">
                <div class="card">
                  ...
                  <img class="card-img-top" width="100%" height="100%" alt="<?php echo $blog->title; ?>" src="{{url(($blog->image)??'#')}}" data-echo="{{url(($blog->image)??'#')}}" style="height: 180px !important; width: 100%;" class="img-fluid card-img-top" alt="...">
