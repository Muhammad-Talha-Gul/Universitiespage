                ...
                <div class="card dropdown-search-main">
                    ...
                    <div id="collapse<?php echo $count_accordion_browse_home; ?>" class="collapse <?php if ($count_accordion_browse_home == 1) {
                        ...
                        <div class="card-body Selectone" style="border: none; margin-top: 10px;">
                            <p class="card-inner-heading">{!! ($ser['text'])??'' !!}</p>
                            <ul>
                                @if(isset($ser['type']))
                                @if($ser['type'] == 'programs')
                                @if(count(getSearchList($ser['type']))>0)
                                @foreach(getSearchList($ser['type']) as $val)
                                <li>
                                <a href="{{url('search?type=course&qualification='.$val->id)}}">
                                        <span>{{$val->title}}</span>
                                    </a>
                                </li>
                                @endforeach
                                @endif
                                @elseif($ser['type'] == 'university')
                                @if(count(getSearchList($ser['type']))>0)
                                @foreach(getSearchList($ser['type']) as $val)
                                <li><a href="{{url('university/'.$val->slug)}}">
                                        <span> {{$val->name}} </span>
                                    </a></li>
                                @endforeach
                                @endif
...
<section class="courses-banner">
    <div class="container">
        ...
        <!-- <div class="firstsectionimgbg" style="background-image:url({{url((fix($meta['bg_image']))??iph())}});background-position: center;background-size: cover;background-repeat: no-repeat;"> -->
...
<div class="py-5 {{($meta['class'])??''}}" id="student_main_search">
                        ...
                        <form action="javascript:void(0);" id="DesktopFilter" class="card u-boxShadow-light l-labelList p-3 mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-12 fieldset mt-3">
                                    ...
                                    <select name="type" class="custom-select w-100 mb-3 inputtype type-select search-select" style="border: 1px solid #ccc; border-radius: 0.25rem; " v-model="location" @change="countrySelected()">
                                        ...
                                        @foreach(getSelectedCountries() as $key => $country_obj)
                                        <option value="{{$country_obj->country}}">{{$country_obj->country}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="fieldset dsp-0 show-uni" style="margin-top:20px;">
                                ...
                                <select name="university" class="custom-select select2 w-100 mb-3 university-select search-select">
                                    ...
                                    @foreach(getAllUniversity() as $uni)
                                    <option value="{{$uni->id}}" :selected="university == '{{$uni->id}}'">{{$uni->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="fieldset dsp-0 show-sub" style="margin-top:20px;">
                                ...
                                <select name="country" class="custom-select select2 w-100 mb-3 subject-select search-select">
                                    ...
                                    <option value="{{$key}}" :selected="subject == '{{$key}}'*1">{{$sub}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="fieldset dsp-0 show-gui" style="margin-top:20px;">
                                ...
                                <div class="half_width">
                                    <label>
                                        <input type="checkbox" name="guide[]" value="university" @if(isset($_GET['guide'])) @if(in_array('university', explode(',',$_GET['guide']))) checked="" @endif @else checked="" @endif @click="filterC($event, 'guide')">
                                        <span>University </span>
                                    </label>
                                </div>
                                <div class="half_width">
                                    <label>
                                        <input type="checkbox" name="guide[]" value="subject" @if(isset($_GET['guide'])) @if(in_array('subject', explode(',',$_GET['guide']))) checked="" @endif @else checked="" @endif @click="filterC($event, 'guide')">
                                        <span>Subjects </span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="see-more">
                                <div class="fieldset dsp-0 show-dur" style="margin-top:20px;">
                                    ...
                                    <label class="search-label input-50">Min Year
                                        <select name="minDur" class="custom-select duration-select w-100 mb-3">
                                            ...
                                            <option v-for="i in 11" :selected="`{{($_GET['minDur'])??0}}`== i" :value="i" v-text="i"></option>
                                        </select></label>
                                    <label class="search-label input-50">Max Year
                                        <select name="maxDur" class="custom-select duration-select w-100 mb-3">
                                            <option value="0">Any</option>
                                            <option v-for="i in 11" :selected="`{{($_GET['maxDur'])??0}}`== i" :value="i" v-text="i"></option>
                                        </select>
                                    </label>
                                </div>
                                ...
                                <div class="fieldset dsp-0 show-fee" style="margin-top:20px;">
                                    ...
                                    <label class="search-label input-50">Min Fee
                                        <input type="number" class="custom-input w-100" min="0" @keyup="minFee= $event.target.value" name="minFee" value="{{($_GET['minFee'])??0}}">
                                    </label>
                                    <label class="search-label input-50" style="position: relative;">Max Fee
                                        <input type="number" class="custom-input w-100" max="0" @keyup="maxFee= $event.target.value" name="maxFee" value="{{($_GET['maxFee'])??0}}">
                                ...
                                {{-- <div class="fieldset dsp-0 show-lan">--}}
                                {{-- <label class="h6 font-weight-bold"  style="display:none;">Language</label>--}}
                                {{-- @foreach(getUniLanguages() as $lan)--}}
                                {{-- <div class="half_width" style="display:none;">--}}
                                {{-- <label>--}}
                                {{-- <input type="checkbox" name="languages[]" value="{{$lan}}" @if(isset($_GET['languages'])) @if(in_array($lan, explode(',',$_GET['languages']))) checked="" @endif @else checked="" @endif @click="filterC($event, 'languages')">--}}
                                {{-- <span>{{$lan}} </span>--}}
                                {{-- </label>--}}
                                {{-- </div>--}}
                                {{-- @endforeach--}}
                                ...
                                <div class="fieldset dsp-0 show-qua" style="margin-top:20px;">
                                    ...
                                    <div class="half_width">
                                        <label>
                                            <input type="checkbox" name="qualification[]" value="{{$qual->id}}" @if(isset($_GET['qualification'])) @if(in_array($qual->id, explode(',',$_GET['qualification']))) checked="" @endif @else checked="" @endif @click="filterQual($event)">
                        ...
                        <section class="mb-3">
                            <div class="row " v-if="(universities.data && universities.data.length>0)">
                                <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-3 search-column  universities-card-column" v-for="uni in universities.data">
                                    <article class="row  no-gutters align-items-center flex-nowrap border-bottom border-top u-small95 pt-4 course-articles" onerror="if(this.src!='{{url(iph())}}'){this.src='{{url(iph())}}'}">
...
<script>
    ...
    var content234 = new Vue({
        ...
        data: {
            authtype: '{{(auth()->check())?auth()->user()->user_type:0}}',
            ...
            star: "{{($_GET['star'])??''}}",
            scholarship: "{{($_GET['scholarship'])??2}}",
            // languages:[],
