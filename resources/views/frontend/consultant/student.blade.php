...
<div class="card">
    <img src="<?php if($profilephoto == '') { echo 'https://st.depositphotos.com/2101611/3925/v/600/depositphotos_39258143-stock-illustration-businessman-avatar-profile-picture.jpg'; } else { echo config('app.url').'public/assets_frontend/cstudent/'.$profilephoto; } ?>" alt="Person" class="card__image">
      <br><p class="card__name" style="color: #0077c1;font-weight: bold;"><span style="color: #000000;">Name:</span><br><br>  {{$cstudent->name}}</p>
      <p class="card__name" style="color: #0077c1;font-weight: bold;"><span style="color: #000000;">Intrested Country:</span><br><br>  {{$cstudent->intrested_country_doc}}</p>
    <p class="card__name" style="color: #0077c1;font-weight: bold;"><span style="color: #000000;">Passport Number:</span><br><br>  {{$cstudent->passport_number}}</p>   
  </div>
</div>
