        ...
        <div class="container">
            ...
            <div class="dashboard-edit-profile" style="background: #fff;">
                <div class="row" id="complaint">
                    ...
                    <form action="{{url('send-mail')}}" method="POST" style="width:100%;">
                        {{csrf_field()}}
                        <input type="hidden" name="type" value="complaint">
                        <div class="row">
                            <div class="form-group col-md-6 p-relative">
                                <label class="form__label dashboard-form-label">Name</label>
                                <input type="text" class="form-control" required="" value="{{old('name')}}" name="name" autocomplete="Off" placeholder="Name">
                            </div>
                            <div class="form-group col-md-6 p-relative">
                                <label class="form__label dashboard-form-label">Email</label>
                                <input type="email" class="form-control" required="" value="{{old('email')}}" name="email" autocomplete="Off" placeholder="Email">
                            </div>
                            <div class="form-group col-md-6 p-relative">
                                <label class="form__label dashboard-form-label">Subject</label>
                                <input type="text" class="form-control" required="" value="{{old('subject')}}" name="subject" autocomplete="Off" placeholder="Subject">
                            </div>
                            <div class="form-group col-md-6 p-relative">
                                <label class="form__label dashboard-form-label">Phone No.</label>
                                <input type="number" class="form-control" required="" value="{{old('phone')}}" name="phone" autocomplete="Off" placeholder="Phone Number">
                            </div>
                            ...
                            <div class="form-group col-md-12 p-relative">
                                ...
                                <textarea class="form-control" name="contact_message" required="" rows="6" autocomplete="Off" placeholder="Write Your Message">{{old('contact_message')}}</textarea>
                            </div>
                        </div>
