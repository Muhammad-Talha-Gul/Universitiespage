...
<section class="apply-online-section">
	<div class="w3-container">
		<div class="apply-online-main w3-teal">
			...
			<form action="{{route('apply-online')}}" method="post" enctype="multipart/form-data" id="applyOnlineForm">
			{{ csrf_field() }}
				<div class="modal-body p-0">
					<div class="row input m-0">
						...
						<label for="" class="apply-inpu-label">Enter Email</label>
							...
							@if ($errors->has('student_email'))
								<div class="invalid-feedback">{{ $errors->first('student_email') }}</div>
							@endif
						</div>
					</div>
					<div class="row input m-0">
						...
						<label for="" class="apply-inpu-label">Enter Phone Number</label>
							<input type="number" name="student_phone_number" class="form-control apply-input" placeholder="Enter Your Phone Number ">
							@if ($errors->has('student_phone_number'))
								<div class="invalid-feedback">{{ $errors->first('student_phone_number') }}</div>
							@endif
						</div>
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 mb-3">
						<label for="" class="apply-inpu-label">Enter Last Education</label>
							<input type="text" name="student_last_education" class="form-control apply-input" placeholder="Enter Your Last Education">
							@if ($errors->has('student_last_education'))
								<div class="invalid-feedback">{{ $errors->first('student_last_education') }}</div>
							@endif
						</div>
					</div>
					<div class="row input m-0">
						...
						<label for="" class="apply-inpu-label">Select Country</label>
							<select name="student_country" class="form-control apply-input country" aria-label="Default select example" onchange="loadStates()">
								<option selected disabled>Select Country</option>
							</select>
							@if ($errors->has('student_country'))
								<div class="invalid-feedback">{{ $errors->first('student_country') }}</div>
							@endif
						</div>
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 mb-3">
					...
					<div class="row input m-0 mt-1">
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 mb-3">
							...
							<input type="text" name="student_apply_for" class="form-control apply-input" placeholder="Apply For">
							@if ($errors->has('student_apply_for'))
								<div class="invalid-feedback">{{ $errors->first('student_apply_for') }}</div>
							@endif
						</div>
					...
					<div class="row input m-0 mt-1">
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 mb-3">
							...
							<input type="file" name="student_passport_image" class="form-control apply-input apply-file-input" placeholder="Upload Passport image" style="padding-top:0px !important; padding-left:0px !important;">
						...
						<label for="" class="apply-inpu-label">Upload Last Education image*</label>
							<input type="file" name="student_last_education_images[]" class="form-control apply-input apply-file-input" placeholder="Upload Last Education image" style="padding-top:0px !important; padding-left:0px !important;">
					...
					<script src="https://www.google.com/recaptcha/api.js" async defer></script>
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3 mt-3 pl-0">
...
<script>
	...
	$(document).ready(function() {
		...
		$('#onlineConsultantsTable').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "/api/getOnlineConsultants?access_key=", // Your API endpoint
                    "type": "GET"
                },
                "columns": [
                    { "data": "id" },
...
$(document).ready(function(){
    $("#applyOnlineForm").submit(function(event){
        event.preventDefault();
        var formData = new FormData(this); // 'this' refers to the form element
        
        $.ajax({
            url: "{{ route('apply-online') }}",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
