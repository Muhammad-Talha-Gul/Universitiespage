                    ...
                    <div id="collapseOne" class="collapse show" data-parent="">
                        <div class="card-body Selectone" style="border: none;">
                            <div class="Discountform">
                                ...
                                <form action="{{url('send-offer')}}" method="POST">
                                    {{csrf_field()}}
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 inputcol121">
                                            ...
                                            <input type="text" class="form-control descount-input" required="" value="{{old('name')}}" name="name" autocomplete="Off" placeholder="Enter Your  Name">
                                        </div>
                                        <div class="form-group col-md-6 inputcol121">
                                            <label class="label-control label1">Last Education</label>
                                            <input type="text" class="form-control descount-input" required="" value="{{old('lastEducation')}}" name="lastEducation" autocomplete="Off" required placeholder="Enter Your Last Education">
                                        </div>
                                        <div class="form-group col-md-6 inputcol121">
                                            <label class="label-control label1">Last Education % <small>(Example 70%)</small></label>
                                            <input type="text" class="form-control descount-input" required="" value="{{old('lastEducationPer')}}" name="lastEducationPer" autocomplete="Off" placeholder="Enter Your  Persentage">
                                        </div>
                                        <div class="form-group col-md-6 inputcol121">
                                            <label class="label-control label1">Phone No.</label>
                                            <input type="number" class="form-control descount-input" required="" value="{{old('phone')}}" name="phone" autocomplete="Off" placeholder="Phone Number">
                                        </div>
                                        <div class="form-group col-md-6 inputcol121">
                                        ...
                                        <div class="form-group col-md-12 inputcol121 mt-2">
                                            ...
                                            <textarea class="form-control descount-input textarea p-3" name="familyDetail" required="" rows="6" autocomplete="Off" placeholder="Enter Details">{{old('familyDetail')}}</textarea>
                                        </div>
                                    </div>
