...
<script type="text/javascript" src="{{ asset('assets_backend/js/jquery.blockUI.js') }}"></script>
...
<!-- App js -->
<script type="text/javascript" src="{{ asset('assets_backend/js/jquery.core.js') }}"></script>
<script type="text/javascript" src="{{ asset('assets_backend/js/jquery.app.js') }}"></script>
