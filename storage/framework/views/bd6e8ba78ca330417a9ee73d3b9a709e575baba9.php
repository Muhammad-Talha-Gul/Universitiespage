...
<div class="container">
        ...
        <div class="col-xs-12">
            <div class="page-title-box">
                ...
                <ol class="breadcrumb p-0 m-0">
                    ...
                    <li>
                        <a href="<?php echo e(route('guide.index')); ?>">Guide</a>
                    </li>
                    <li class="active">
                        Edit Guide
                    </li>
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <form action="<?php echo e(route('guide.update',$data->id)); ?>" method="POST" enctype="multipart/form-data"> 
                ...
                <div class="card-box table-responsive">
                    <div class="p-10">
                        <div class="">
                            <div class="col-md-6">
                                <div class="form-group m-b-20">
                                    ...
                                    <select class="form-control select2 guideType" name="guide_type" >
                                        <option value="university" <?php if($data->guide_type=='university'): ?> selected="" <?php endif; ?>>University Guide</option>
                                        <option value="subject" <?php if($data->guide_type=='subject'): ?> selected="" <?php endif; ?>>Subject Guide</option>
                                    </select>
                                </div>
                                <div class="form-group m-b-20">
                                    <label>Guide Title</label>
                                    <input type="text" class="form-control" id="guide-title" name="title" placeholder="Enter title" value="<?php echo e(($data['title'])??''); ?>" required <?php if($data->guide_type=='subject'): ?> readonly="" <?php endif; ?>>
                                </div>
                                <div class="form-group">
                                    <label>Sub Title</label>
                                    <textarea class="form-control" name="sub_title" placeholder="Sub Title" required><?php echo e(($data['sub_title'])??''); ?></textarea>
                                </div>
                                
                            </div>
                        
                            <div class="col-md-6">
                                <div class="form-group m-b-20 university_guide" <?php if($data->guide_type=='subject'): ?> style="display: none"; <?php endif; ?>>
                                    ...
                                    <select class="form-control select_guide select2" name="university_id">
                                        ...
                                        <?php $__currentLoopData = getAllUniversity(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value->id); ?>" <?php if($value->id == $data->university_id): ?> selected="" <?php endif; ?>><?php echo e($value->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="form-group m-b-20 subject_guide" <?php if($data->guide_type=='university'): ?> style="display: none"; <?php endif; ?>>
                                    <label>Subject</label>
                                    <select class="form-control select_guide select2" name="subject_id">
                                        <option selected disabled>Select Any Subject</option>
                                        <?php $__currentLoopData = pluckSubjects(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php if($key == $data->subject_id): ?> selected="" <?php endif; ?>><?php echo e($value); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group m-b-20 feature_im" <?php if($data->guide_type=='subject'): ?> style="display:none;" <?php endif; ?>>
                ...
                <div class="card-box table-responsive">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if(check_access(Auth::user()->id,'guide','_delete')==1): ?>
                            <a href="javascript:void(0)" class="btn btn-danger" onclick="deleteit()">Delete</a>
                            <?php endif; ?>
                            <a href="<?php echo e(route('guide.index')); ?>" class="btn btn-success">Back</a>
                        </div>
                    </div>
                </div>
            </form>
            <form action="<?php echo e(route('guide.destroy',$data['id'])); ?>" method="POST" id="delete-form">
