	...
	<div class="row">
		<div class="col-md-12">
			<div class="card-box table-responsive">
                ...
                <a download href="https://universitiespage.com/articles_sitemap.xml" class="btn btn-success btn-md pull-right" style="margin-bottom: 10px;">Generate Site-map</a>
                <a href="<?php echo e(route('blog.create')); ?>" class="btn btn-primary btn-md pull-right" style="margin-bottom: 10px;margin-right:10px;">Add Post</a>
                <?php endif; ?>
                ...
                <table id="datatable" class="table table-striped table-bordered">
                	...
                	<tr>
                        <td><?php if(empty($value->image)): ?>
                            No Image
                            <?php else: ?>
                            <img src="<?php echo e(url($value->image)); ?>" width="100">
                            <?php endif; ?>
                        </td>
                        <td><?php echo e($value->title); ?>/ <a href="<?php echo e(url($value->slug)); ?>" target="_blank"><i class="fa fa-eye"></i></a></td>
                        ...
                        <?php if(check_access(Auth::user()->id,'blog','_edit')==1): ?>
                		<td><a href="<?php echo e(route('blog.edit',$value->id)); ?>" class="btn btn-warning btn-md">Edit</a></td>
                        <?php endif; ?>
                	</tr>
                ...
                <div> <!-- by sadam -->
                    ...
                    { 
                        ...
                        { 
                            $string .= '<url>';
                            $string .= '<loc>'.$baseURL.(isset($slug->slug)? $slug->slug : '').'</loc>';
                        ...
                        $string .='</urlset>';
                        file_put_contents("articles_sitemap.xml", $string);
