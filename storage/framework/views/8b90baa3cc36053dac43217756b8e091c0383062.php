...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
            <form action="<?php echo e(route('updatePage',$data['id'])); ?>" method="POST"> 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="title" id="page-title" value="<?php echo e($data['title']); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-md-3 control-label"><?php echo e(url("/page")); ?>/</label>
                                <div class="col-md-10">
                ...
                <div class="card-box table-responsive">
                    <div class="row" id="components">
                        ...
                        <?php $__env->startComponent('admin.components.search',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="buttons"): ?>
                        <?php $__env->startComponent('admin.components.buttons',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="programs"): ?>
                        <?php $__env->startComponent('admin.components.programs',['sliders'=>$sliders,'rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="editor"): ?>
                        <?php $__env->startComponent('admin.components.editor',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>
                        
                        <?php elseif($value->type=="guide"): ?>
                        <?php $__env->startComponent('admin.components.guide',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="blog"): ?>
                        <?php $__env->startComponent('admin.components.blog',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="banner"): ?>
                        <?php $__env->startComponent('admin.components.banner',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="popular"): ?>
                        <?php $__env->startComponent('admin.components.popular',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="consultant"): ?>
                        <?php $__env->startComponent('admin.components.consultant',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="institution"): ?>
                        <?php $__env->startComponent('admin.components.institution',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="courses"): ?>
                        <?php $__env->startComponent('admin.components.courses',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="contact"): ?>
                        <?php $__env->startComponent('admin.components.contact',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="spacer"): ?>
                        <?php $__env->startComponent('admin.components.spacer',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="login"): ?>
                        <?php $__env->startComponent('admin.components.login',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="register"): ?>
                        <?php $__env->startComponent('admin.components.register',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>

                        <?php elseif($value->type=="forum"): ?>
                        <?php $__env->startComponent('admin.components.forum',['rand'=>$key,'meta'=>json_decode($value['meta'],true)]); ?> <?php echo e($value->title); ?> <?php echo $__env->renderComponent(); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea rows="5" class="form-control" name="custom_css" placeholder="Add your custom styles here"><?php echo isset($data->custom_css) ? $data->custom_css : ''; ?></textarea>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-box table-responsive">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="<?php echo e(route('dynamicPages')); ?>" class="btn btn-success">Back</a>
                        </div>
                    </div>
                </div>
            </form>
            <form action="<?php echo e(route('deletePage',$data['id'])); ?>" method="POST" id="delete-form">
...
jQuery(document).ready(function(){
    ...
    $(".component").click(function(){
        ...
        var data = { '_token':"<?php echo e(csrf_token()); ?>", 'comp':$(this).data('comp') };
        jQuery.ajax({
            url:'<?php echo e(route("ajaxGetComps")); ?>',
            type: 'post',
            dataType: 'html',
            data: data,
        ...
        var html=`
            <div class="topic form-group col-lg-3 col-md-4 col-sm-6" style="position: relative;">
                <div class="image-placeholder" id="wfm`+key+`" data-input="`+key+`b1-`+rand+`-hidden" data-preview="`+key+`b1-`+rand+`-holder">
                    <img src="<?php echo e(asset('placeholder.jpg')); ?>" id="`+key+`b1-`+rand+`-holder" class="img-responsive img-selection img-thumbnail" style="max-height:300px">
                </div>
