            ...
            <div class="card-box table-responsive">
                ...
                <table id="datatable" class="table hover">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($value->student_email); ?></td>
                        <td><?php echo e($value->student_phone_number); ?></td>
                        <td><?php echo e($value->student_country); ?></td>
                        <td><?php echo e($value->student_state); ?></td>
                        <td><?php echo e($value->student_city); ?></td>
                        <td><?php echo e(date('dS M, Y h:i a',strtotime($value->created_at))); ?></td>
                        <td>
                            <?php if(check_access(Auth::user()->id,'student','_show')==1): ?><a href="<?php echo e(route('consultant-details', ['id' =>$value->id])); ?>" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
                            <?php endif; ?>
                            <?php if(check_access(Auth::user()->id,'student','_show')==1): ?><a href="<?php echo e(route('consultant-delete', ['id' =>$value->id])); ?>" class="btn btn-info btn-xs"><i class="fa fa-trash"></i></a>
                            <?php endif; ?>
