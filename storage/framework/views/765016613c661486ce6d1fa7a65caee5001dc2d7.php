...
<br><br>
     ...
     <div class="container" style="border: 1px solid grey; padding: 15px; background: #0B6D76; border-radius: 5px;">
         

        <ul class="list-group list-group-horizontal" style="display: table;">
...
<div class="container">
      ...
      <?php if(count(getBlogs(0,$category))>0): ?>
          ...
          <div class="row">
                ...
                <!-- <style type="text/css">
                    .imgcol {
                        background-image: url(<?php echo e(url(($blog->image)??'#')); ?>);
                    }
                </style> -->
        
                <div class="col-lg-6 col-md-12 imgcol">
                ...
                <div class="col-lg-6 colmd12 textcol">
        
                   <a href="<?php echo e(url(($blog->slug)??'#')); ?>"> <h3><?php echo e(($blog->title)??''); ?></h3> </a>
          ...
          <?php $check_count = 1; } else { ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 imgcol">
                 <a href="<?php echo e(url(($blog->slug)??'#')); ?>">   <img class="card-img-top" width="100%" height="100%" alt="<?php echo $blog->title; ?>" src="<?php echo e(url(($blog->image)??'#')); ?>" data-echo="<?php echo e(url(($blog->image)??'#')); ?>"></a>
                </div>
        ...
        <?php  } ?>
         ...
         <?php if(count(getBlogs($paginate,$category))>0 && $paginate !== 0 && count(getBlogs($paginate,$category))<count(getBlogs(0,$category))): ?>
              ...
              <ul class="pagination small">
                ...
                <?php if($result->currentPage()!=1): ?><li class="page-item active"><a class="page-link" href="<?php echo e($result->url(1)); ?>"><i class="fa fa-chevron-left"></i></a></a></li><?php endif; ?>
                   <?php for($i=1; $i<$count; $i++): ?>
                       <li class=<?php echo e(($result->currentPage()==$i)?'active page-item':'page-item'); ?>>
...
<?php else: ?>
  ...
  <div class="o-2colLayout container">
    <main class="o-2colLayout-content mr-md-5">
      ...
      <header class="mb-3">
        <h1 class="m-0"><?php echo e($blog->title); ?></h1>
      ...
      <section class="s-content clearfix mb-4"><?php echo $blog->description; ?></section>
