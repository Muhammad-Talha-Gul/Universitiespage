...
<div class="container">
        ...
        <div class="col-xs-12">
            <div class="page-title-box">
                ...
                <ol class="breadcrumb p-0 m-0">
                    ...
                    <li>
                        <a href="<?php echo e(route('blog.index')); ?>">Visa Country</a>
                    </li>
                    <li class="active">
                        Edit Visa Country
                    </li>
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <form action="<?php echo e(route('visacountries.update',$data['id'])); ?>" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="">
                            <div class="col-md-6">
                                <div class="form-group m-b-20">
                                    ...
                                    <input type="text" class="form-control" id="blog-title" name="country_name" placeholder="Enter title" value="<?php echo e($data['country_name']); ?>" required>
                                </div>
                            </div>
                            <div class="clearfix"></div>   

                            <?php if(empty($data['country_image'])): ?>
                            <div class="form-group m-b-20">
                            ...
                            <div class="form-group m-b-20">
                                ...
                                <div class="image-placeholder" id="wfm" data-input="f-hidden" data-preview="f-holder">
                                    <img src="<?php echo e(url($data['country_image'])); ?>" id="f-holder" class="img-responsive img-selection img-thumbnail" style="max-height:300px">
                                </div>
                                <a href="javascript:void(0)" class="removeImage" data-hidden="f-hidden" data-holder="f-holder" style="display: none">Remove Image</a>
                                <input type="hidden" name="country_image" id="f-hidden" value="<?php echo e($data['country_image']); ?>">
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <form action="<?php echo e(route('visacountries.destroy',$data['id'])); ?>" method="POST" id="delete-form">
