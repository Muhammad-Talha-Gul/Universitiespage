                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="580" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p25t es-p25b es-p10r es-p10l" align="center" style="font-size: 0px;"><a href="https://universitiespage.com/" target="_blank"><img src="https://demo.stripocdn.email/content/guids/ba1a44d6-d454-482d-b61c-c7c368b9d6ca/images/49711612707188926.png" alt style="display: block;" width="90"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                                        <p>
                                                                                                <b><?php echo $unv_name; ?></b> Received a request of Admission information from Student. <b><?php echo $unv_name; ?></b> may contact directly with the student by Email or Phone number for further processing.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="center">
                                                                                        <p><strong><u>Student Profile</u></strong></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                        <ul>
                                                                                            <li><b>Student Name: </b>
                                                                                               <?php echo $student_first_name.' '.$student_last_name; ?></li>
                                                                                        </ul>
                                                                                        <ul>
                                                                                            <li><b>Nationality:</b>
                                                                                                <?php echo $student_country; ?>
                                                                                            </li>
                                                                                        </ul>
                                                                                        <ul>
                                                                                            <li><b>Age:</b>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                        <p><small>
                                                                                                   <b><?php echo $unv_name; ?></b> has option to cooperation with us to do promotion and marketing of
                                                                                                <b><?php echo $unv_name; ?>.</b> We also provide students recruitment services to universities and colleges.</small></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left"><a target="_blank" href="https://universitiespage.com/">Contact us</a></td>
                                                                                </tr>
                                           <br>                                     <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p30t es-p30r es-p30l" align="center">
                                                                                        <h3 style="color: #111111;">Do you think,this is not relevent university/department or wrong Email Address?</h3>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p30b es-p30r es-p30l" esdev-links-color="#ffa73b" align="center"><a target="_blank" href="mailto:info@universitiespage.com?subject=Universities%20Paid%20Marketing" style="color: #ffa73b;">Please write to us</a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p25t">
                                                                                        <p>Note:All universities and course information is collected by publicly accessed websites from internet,Therefore,there are chances that we have some incorrected information about your University/College and course fee etc.If you find any mistake, please contact with us and specify the mistakes. We will correct the information on our first priority.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p25t">
                                                                                        <p>If these emails get annoying, please feel free to write us&nbsp;<strong><a target="_blank" class="unsubscribe" href="mailto:info@universitiespage.com?subject=unsubscribe">unsubscribe</a></strong>.</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-infoblock made_with" align="center" style="font-size: 0px;"><a target="_blank" href="https://universitiespage.com/"><img src="https://demo.stripocdn.email/content/guids/ba1a44d6-d454-482d-b61c-c7c368b9d6ca/images/49711612707188926.png" alt="Universities Page" width="125" style="display: block;" title="Universities Page" class="adapt-img"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
