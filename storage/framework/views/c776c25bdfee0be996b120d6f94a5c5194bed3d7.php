...
<div class="container">
  <div class="details-banner herrobgimg university-details-banner my-4" <?php if($data->feature_image!==null): ?> style="background-image: url(<?php echo e(url((isset($data->feature_image['image'][0]))?fix($data->feature_image['image'][0]):fix($data->logo))); ?>);" <?php endif; ?>>
      <div class="university-details-overlay banner-overlay">
          <div class="banner-contant-main">
              <h6 class="banner-heading details-banner-heading university-details-banner-heading"><?php echo e(($data->name)??''); ?> (<?php echo e(($data->founded_in)??''); ?>)</h6>
              ...
              <p class="banner-sub-heading details-banner-sub-heading"><?php echo $data->city.', '.$data->country; ?></p>
    ...
    <div class="fillter-button-main">
      <div class="fillter-button click-button active"  onclick="openCity(event, 'London')">
        <div class="fillter-button-content">
          <!-- <img class="img-fluid " src="<?php echo e(url('/filemanager/photos/1/new_style/svg/list.svg')); ?>" alt=""> -->
      ...
      <div class="fillter-button click-button"  onclick="openCity(event, 'Paris')">
        <div class="fillter-button-content">
          <!-- <img class="img-fluid  fillter-icon" src="<?php echo e(url('/filemanager/photos/1/new_style/svg/image.svg')); ?>" alt=""> -->
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
      ...
      <!-- <div class="col-lg-2 mb-3 text-center">
        <div class="fillter-button" onclick="openCity(event, 'news')">
          <img class="img-fluid  fillter-icon" src="<?php echo e(url('/filemanager/photos/1/new_style/Vector (11).png')); ?>" alt="">
          <p>News</p>
        </div>
      </div> -->
      <div class="fillter-button click-button course-button" onclick="openCity(event, 'courses')">
        <div class="fillter-button-content">
          <!-- <img class="img-fluid  fillter-icon" src="<?php echo e(url('/filemanager/photos/1/new_style/svg/books.svg')); ?>" alt=""> -->
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
      ...
      <!-- <div class="col-lg-2 mb-3 text-center">
        <div class="fillter-button" onclick="openCity(event, 'apply')">
          <img class="img-fluid  fillter-icon" src="<?php echo e(url('/filemanager/photos/1/new_style/Group 119.png')); ?>" alt="">
          <p>How To Apply</p>
        </div>
      </div> -->
      <div class="fillter-button click-button" onclick="openCity(event, 'reviews')">
        <div class="fillter-button-content">
          <!-- <img class="img-fluid  fillter-icon" src="<?php echo e(url('/filemanager/photos/1/new_style/svg/page.svg')); ?>" alt=""> -->
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="row mb-3">
                      <?php $__currentLoopData = $subject; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div style="cursor: pointer;" class="col-md-4 ">
                          <div class="border mb-3 Accommodationdiv course_search click-button"  data-subid="<?php echo e($sub->id); ?>" onclick="openCity(event, 'courses')">
                            <p class="coursses-paragraph"><?php echo e($sub->name); ?> <span style="color: #0B6D76;">(<?php echo e(count($data->courses->where('subject_id',$sub->id))); ?>)</span></p>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 mb-2 slider-column">
                          <div class="card slider-card">
                            <a href="<?php echo e(url('university/'.$uni->slug)); ?>" class="slider-link">
                              <div class="slider-image-container">
                                <img class="img-fluid slider-image" src="<?php echo e(url((fix($uni->logo, 'thumbs')))??iph()); ?>" alt="university" alt="">
                              </div>
                              <div class="slider-content">
                                <h6 class="slider-heading"><?php echo e($uni->name); ?></h6></a>
                                <p class="slider-paragraph"><i class="fa-sharp fa-light fa-location-dot"></i> <?php echo e($uni->city); ?>, <?php echo e($uni->country); ?></p>
                              </div>
                            </a>
                          </div>
                        </div>
            ...
            <div id="aniimated-thumbnials">
              <div class="row">
                <?php if(isset($data->feature_image)): ?>
                  ...
                  <?php endfor; ?>
                  <?php else: ?> <p class="not-found">No Images Found</p>
                <?php endif; ?>
              </div>
            </div>
          </div>
