...
<?php if(check_access(Auth::user()->id,'course','_edit')==1): ?>
<div class="container">
    <div class="row">
        <div class="col-xs-12">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo e(route('course.update', $data->id)); ?>" method="POST" enctype="multipart/form-data"> 
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text" class="form-control" name="name" placeholder="Course Name" value="<?php echo e($data->name); ?>" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="number" class="form-control" name="duration_qty" placeholder="Year/Months in No." value="<?php echo e($data->duration_qty); ?>" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <select name="duration_type" class="form-control" required>
                                                                    <option <?php if($data->duration_type == 'Year'): ?> selected <?php endif; ?> value="Year">Year</option>
                                                                    <option <?php if($data->duration_type == 'Months'): ?> selected <?php endif; ?> value="Months">Months</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <?php else: ?>
                                                                    <select name="university_id" class="form-control select2" required>
                                                                        <?php $__currentLoopData = $universities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $university): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option value="<?php echo e($university->id); ?>" <?php if($data->university_id == $university->id): ?> selected <?php endif; ?>><?php echo e($university->name); ?></option>
                                                            ...
                                                            <div class="col-md-11">
                                                                <select class="form-control select2" name="subject_id" required>
                                                                    ...
                                                                    <?php $__currentLoopData = subjects(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($sub->id); ?>" <?php if($data->subject_id == $sub->id): ?> selected <?php endif; ?>><?php echo e($sub->name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-11">
                                                                <select class="form-control select2" name="qualification" required>
                                                                    <?php $__currentLoopData = qualification(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($edu->id); ?>" <?php if($data->qualification == $edu->id): ?> selected <?php endif; ?>><?php echo e($edu->title); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            <label class="col-md-6 control-label">Starting Date</label>
                                                            <div class="col-md-11">
                                                                <input type="text" class="form-control datepicker-autoclose" name="starting_date" placeholder="Starting Date" value="<?php echo e($data->starting_date); ?>" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text"  class="form-control" name="yearly_fee" placeholder="Yearly Fee" value="<?php echo e($data->yearly_fee); ?>" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            <label class="col-md-12 control-label">Application Fee</label>
                                                            <div class="col-md-11">
                                                                <input type="number" class="form-control" name="application_fee" placeholder="Appplication Fee" value="<?php echo e($data->application_fee); ?>" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-11">
                                                                <input type="text" class="form-control tags" name="languages" value="<?php echo e($data->languages); ?>" placeholder="Teaching Languages" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <!--- schema markup satart by awais --->
                                                        ...
                                                        <?php 
                                                            ...
                                                            <div class="optionBox2">
                                                                    ...
                                                                    <?php 
                                                                     $review_detail = !empty(json_decode($data->review_detail))? json_decode($data->review_detail):[];
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 10px;clear: both;">
                                                        <div class="form-group">
                                                            <label class="col-md-12 control-label">Sort Order</label>
                                                            <div class="col-md-11">
                                                                <input type="number" class="form-control" name="sort_order" placeholder="Yearly Fee" value="<?php echo e($data->sort_order); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="p-20">
                                            <div class="">
                                                <div class="form-group col-sm-10">
                                                    <label>About</label>
                                                    <textarea class="form-control" name="about" placeholder="about"><?php echo $data->about; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-20">
                                            <div class="">
                                                <div class="form-group col-sm-10">
                                                    ...
                                                    <textarea class="summernote" name="entry_requirments"><?php echo $data->entry_requirments; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="">
                                                <div class="">
                                                    <div class="form-group col-sm-10">
                                                        ...
                                                        <textarea class="summernote" name="curriculum"><?php echo $data->curriculum; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="card-box table-responsive">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="checkbox checkbox-primary">
                                    <input type="checkbox" name="active" value="1" <?php if($data->active == 1): ?> checked <?php endif; ?>>
                                    <label>Active</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <div class="checkbox checkbox-primary">
                                <input type="checkbox" name="scholarship" <?php if($data->scholarship == 1): ?> checked <?php endif; ?> value="1" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if(check_access(Auth::user()->id,'course','_delete')==1): ?>
            ...
            <form action="<?php echo e(route('course.destroy',$data['id'])); ?>" method="POST" id="delete-form-<?php echo e($data->id); ?>">
...
<script>
    var x = document.createElement("yearly_fee");
