                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="number" class="form-control" name="phone" placeholder="Phone" value="<?php echo e(old('phone')); ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="university_name" placeholder="University Name" value="<?php echo e(old('university_name')); ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <select class="form-control select2" name="country" value="">
                                                                    ...
                                                                    <option value="<?php echo e($value->country); ?>"><?php echo e($value->country); ?></option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control date-picker-year" name="founded_in" value="<?php echo e(old('founded_in')); ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control tags" name="intake" value="<?php echo e(old('intake')); ?>">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control tags" name="languages" value="<?php echo e(old('languages')); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>                                   
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <div class="image-placeholder" id="wfm" data-input="f-logo-hidden" data-preview="f-logo-holder">
                                                            <img src="<?php echo e(asset('placeholder.jpg')); ?>" id="f-logo-holder" class="img-responsive img-selection img-thumbnail" style="max-height:300px">
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control accommodation-change" name="accommodation" required>
                                                            <option value="On Campus" <?php if(old('accommodation') == 'On Campus'): ?> selected="" <?php endif; ?>>On Campus</option>
                                                            <option value="Off Campus" <?php if(old('accommodation') == 'Off Campus'): ?> selected="" <?php endif; ?>>Off Campus</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-sm-10 accommodation_detail" <?php if(old('accommodation') == 'Off Campus'): ?> style="display:none;" <?php endif; ?>>
