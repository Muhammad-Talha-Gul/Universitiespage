<?php echo $__env->make('includes.backend.leftSidebar', ['permissions' => $permissions], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <ul>
                ...
                <?php if(isset($permissions)): ?>
                    <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <?php if(isset($permissionArray['slider']) && $permissionArray['slider'] === 'on'): ?>
                            <!-- Display Slider link -->
                            <li>
                                <a href="#">
                                    <i class="mdi mdi-view-dashboard"></i> <span> Slider </span>
                                </a>
                            </li>
                        <?php endif; ?>
