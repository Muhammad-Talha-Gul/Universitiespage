                            ...
                            <div class="col-sm-12">
                                <div class="card-box m-t-20">
                                    ...
                                    <div style="font-size: 16px;">
                                        ...
                                        <b>Address: </b> <?php echo e($consultant->student_apply_for); ?><br>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2" style="min-width: 280px; margin-bottom:20px;">
                                            <h5 class="details-image-heading">Last Education Image:</h5>
                                                <div class="details-image-main">
                                                    <!-- Display last education image -->
                                                    <?php if($consultant->student_last_education_image): ?>
                                                        <img src="<?php echo e(asset('uploads/images/' . $consultant->student_last_education_image)); ?>" alt="Last Education Image" class="details-image" id="educationImage"><br>
                                                        <button onclick="downloadEducationImage('educationImage')" class="dowload-button"><i class="fa fa-download"></i></button>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2" style="min-width: 280px; margin-bottom:20px;">
                                                <h5 class="details-image-heading">Passport Image:</h5>
                                                <div class="details-image-main">
...
<script type="text/javascript">
    ...
    function downloadEducationImage(imageId) {
        var imageElement = document.getElementById(imageId);
    if (imageElement) {
        var imageUrl = imageElement.src;
        var originalFilename = imageUrl.substring(imageUrl.lastIndexOf('/') + 1);
