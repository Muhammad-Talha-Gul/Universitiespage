...
<?php endif; ?>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets_frontend/css/custom.css')); ?>">

        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets_frontend/css/new_style.css')); ?>">

        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets_frontend/css/pages.css')); ?>">
...
})(window,document,'script','dataLayer','GTM-N6TNFD4');</script>
...
<script>
  ...
  OneSignal.push(function() {
    ...
    <!-- Meta Pixel Code -->
        ...
        src="https://www.facebook.com/tr?id=707529750730580&ev=PageView&noscript=1"
        /></noscript>
    <!-- End Meta Pixel Code -->
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N6TNFD4"
...
<?php echo $__env->make('frontend.student.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
 ...
 <script type="text/javascript" src="<?php echo e(asset('assets_frontend')); ?>/js/whatsapp-chat.js"></script>
    <link rel="stylesheet" href="<?php echo e(asset('assets_frontend')); ?>/css/whatsapp-chat.css">
   <style>
     .ayoan_whatsapp_chatbox_container {z-index: 1000; width:375px !important;}
        ...
        <script>
          ...
          var notification = new Vue({
              ...
              methods: {
                  get_notification() {
                      var _this = this;
                      axios.post(_this.baseUrl + '/user-notifcation').then(response => {
    ...
    $(document).ready(function() {
      $("#imageSlider3").owlCarousel({
        ...
        $.ajax({
              ...
              type: 'POST',
              dataType: 'json',
              data: {action_button: action_button, page_hit_name: page_hit_name, whatsapp_button_text: whatsapp_button_text, _token: csrfToken},
              success: function (data) {
