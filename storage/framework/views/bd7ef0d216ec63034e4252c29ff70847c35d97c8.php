	...
	<style type="text/css">
		  ...
		  *, *:before, *:after {
		  ...
		  .check_main {
			...
			background: linear-gradient(0deg, rgba(233,233,233,1) 0%, rgba(255,255,255,1) 64%);
			cursor: pointer;
		  ...
		  .check_main:hover {
	          ...
	          background: linear-gradient(0deg, rgba(126,126,126,1) 0%, rgba(70,70,70,1) 64%);
		  }
		  ...
		  .f_declaration input[type="checkbox"]:not(old) + label, input[type="radio"]:not(old) + label {
		      display: initial;
		      margin-left: -28px;
		      padding-left: 28px;
		  ...
		  .declaration input[type="checkbox"]:not(old) + label, input[type="radio"]:not(old) + label {
		  ...
		  .f_check input[type="checkbox"]:not(old) + label, input[type="radio"]:not(old) + label {
		  ...
		  */
		  ...
		  <!-- CODE FOR UPLOAD TWO RESPONSIVE DIVS -->
		  <style type="text/css">
		  .upload-content-area {
		  ...
		  #one { background-color: whitesmoke; }
		  #two { background-color: #f5f5f5; }
		  ...
		  .file-info {
		    font-size: 0.9em;
		    margin-left: 5px;
		    background-color: transparent;width: initial;
		    border: none;
		  }
		  .file-info:focus{
		  	outline: none;
...
<?php $__env->startSection('content'); ?>
	...
	<section>
		<div class="container nmargin apply_detail" id="application_form">
			<div class="grid grid--vcenter grid--space f_grid">
				<div class="grid__item">
					<div class="row">
						<div class="col-sm-12">
							<h5 style="margin-bottom:35px;text-align: center;">You're applying for <?php echo e($data->name); ?> of <?php echo e($data->university->name); ?></h5>
						...
						<div class="col-md-4">
							<div class="w3-sidebar w3-light-grey w3-bar-block" style="width: 93%;">
								<div class="form-group check_main active" data-tab="personal_info">
									<span class="steps">Step 1</span>
									<span>Personal Information</span>
									<i class="fa fa-thumbs-up" <?php if(isset($app->personal_information) && $app->personal_information !== null): ?> style="display:block;" <?php endif; ?>></i>
								</div>
								<div class="form-group check_main" data-tab="educational_background">
									<span class="steps">Step 2</span>
									<span>Educational Background</span>
									<i class="fa fa-thumbs-up" <?php if(isset($app->educational_background) && $app->educational_background !== null): ?> style="display:block;" <?php endif; ?>></i>
								</div>
								<div class="form-group check_main" data-tab="language_qual">
									<span class="steps">Step 3</span>
									<span>Language Qualification</span>
									<i class="fa fa-thumbs-up" <?php if(isset($app->language_qualification) && $app->language_qualification !== null): ?> style="display:block;" <?php endif; ?>></i>
								</div>
								...
								<div class="form-group check_main" data-tab="mailing">
									...
									<i class="fa fa-thumbs-up" <?php if(isset($app->mailling_address) && $app->mailling_address !== null): ?> style="display:block;" <?php endif; ?>></i>
								</div>
								...
								<div class="form-group check_main" data-tab="uploads">
									...
									<i class="fa fa-thumbs-up" <?php if($current==1): ?> <?php if(isset($app->uploads) && $app->uploads !== null): ?> style="display:block;" <?php endif; ?> <?php endif; ?>></i>
								</div>
								<div class="form-group check_main submit-final" data-tab="submit">
									<span class="steps">Final Step</span>
									<span>Complete</span>
									<i class="fa fa-thumbs-up" <?php if($current==1): ?> <?php if(isset($app->status) && $app->status !== 4): ?> style="display:block;" <?php endif; ?> <?php endif; ?>></i>
								</div>
							</div>
						</div>
						<div class="col-md-8">
								...
								<div class="main_tabs">
									<section class="personal_info active">
										<div class="w3-container w3-teal row">
											<div class="col-sm-12">
												...
												<form class="form_submit" data-next="educational_background" data-current="personal_info">
												<div class="row">
													...
													<div class="w3-container main_side col-sm-6" align="left">
														...
														<div :class="(errors.first_name)?'form-group has_error':'form-group'">
															...
															<input type="text" class="form-control" name="first_name" v-model="personal_info.first_name">
														...
														<div :class="(errors.last_name)?'form-group has_error':'form-group'">
															<label class="label__control">Family Name/Surname 
																<span class="label__required">*</span></label>
															<input type="text" class="form-control" name="last_name" v-model="personal_info.last_name">
														...
														<div :class="(errors.dob)?'form-group has_error':'form-group'">
															<label class="label__control">Date of Birth
																<span class="label__required">*</span></label>
															<input type="text" class="form-control change_select datepicker-autoclose" data-name="dob" name="dob" readonly data-date-format="yyyy-mm-dd" data-language="en" :value="personal_info.dob">
														...
														<div :class="(errors.nationality)?'form-group has_error':'form-group'">
															...
															<input type="text" class="form-control" name="passport" v-model="personal_info.nationality">
														...
														<div :class="(errors.passport)?'form-group has_error':'form-group'">
															<label class="label__control">Passport No
																<span class="label__required">*</span></label>
															<input type="text" class="form-control" name="passport" v-model="personal_info.passport">
														...
														<div :class="(errors.valid_until)?'form-group has_error':'form-group'">
															<label class="label__control">Passport Validity
																<span class="label__required">*</span></label>
															<input type="text" class="form-control change_select datepicker-autoclose" data-name="valid" readonly data-date-format="yyyy-mm-dd" data-language="en" :value="personal_info.valid_until">
													...
													<div class="w3-container main_side col-sm-6" align="left">
														...
														<div :class="(errors.religion)?'form-group has_error':'form-group'">
															...
															<input type="text" class="form-control" name="religion" v-model="personal_info.religion">
														...
														<div :class="(errors.previous_education)?'form-group has_error':'form-group'">
															<label class="label__control">Previous Education
																<span class="label__required">*</span></label>
															<input type="text" class="form-control" name="previous_education" v-model="personal_info.previous_education">
														...
														<div :class="(errors.field_of_study)?'form-group has_error':'form-group'">
															<label class="label__control">Field Of Study
																<span class="label__required">*</span></label>
															<input type="text" class="form-control" name="field_of_study" v-model="personal_info.field_of_study">
														...
														<div :class="(errors.c_address)?'form-group has_error':'form-group'">
															<label class="label__control">Address<span class="label__required">*</span></label>
															<input type="text" class="form-control" name="c_address" v-model="personal_info.c_address">
														...
														<div :class="(errors.c_phone)?'form-group has_error':'form-group'">
															<label class="label__control">Tele<span class="label__required">*</span></label>
															<input type="text" class="form-control" name="c_phone" v-model="personal_info.c_phone">
														...
														<div :class="(errors.p_address)?'form-group has_error':'form-group'">
															<label class="label__control">Address<span class="label__required">*</span></label>
															<input type="text" class="form-control" name="p_address" v-model="personal_info.p_address">
														...
														<div :class="(errors.p_phone)?'form-group has_error':'form-group'">
															<label class="label__control">Tele<span class="label__required">*</span></label>
															<input type="text" class="form-control" name="p_phone" v-model="personal_info.p_phone">
															<span class="error-block" v-if="errors.p_phone" v-for="error in errors.p_phone" v-text="error"></span>
														</div>
													</div>

													<div class="w3-container main_side col-sm-12" align="right" style="height:100px;">
														<button type="submit" class="next-btn">Done</button>
													</div>
										...
										<div class="w3-container w3-teal row">
											...
											<div class="w3-container main_side row">
												...
												<div class="col-sm-4">
													<div :class="(errors.school_name)?'form-group has_error':'form-group'">
														<label class="label__control">School Name 
															<span class="label__required">*</span></label>
														<input type="text" class="form-control" v-model="edu_single.school_name" >
												...
												<div class="col-sm-4">
													<div :class="(errors.field_of_study)?'form-group has_error':'form-group'">
														<label class="label__control">Field Of Study
															<span class="label__required">*</span></label>
														<input type="text" class="form-control" v-model="edu_single.field_of_study" >
														<span class="error-block" v-if="errors.field_of_study" v-for="error in errors.field_of_study" v-text="error"></span>
													</div>
												</div>
												...
												<div class="col-sm-4">
													<div :class="(errors.diploma_received)?'form-group has_error':'form-group'">
														<label class="label__control">Diploma Received
															<span class="label__required">*</span></label>
														<input type="text" class="form-control" v-model="edu_single.diploma_received" >
												...
												<div class="col-sm-4">
													<div :class="(errors.date_of_started)?'form-group has_error':'form-group'">
														<label class="label__control">Date Of Started
															<span class="label__required">*</span></label>
														<input type="text" class="form-control change_select datepicker-autoclose" readonly data-date-format="yyyy-mm-dd" data-name="date_of_started" v-model="edu_single.date_of_started" data-language="en">
												...
												<div class="col-sm-4">
													<div :class="(errors.date_of_graduation)?'form-group has_error':'form-group'">
														<label class="label__control">Date Of Graduation
															<span class="label__required">*</span></label>
														<input type="text" class="form-control change_select datepicker-autoclose" readonly data-date-format="yyyy-mm-dd" data-name="date_of_graduation" v-model="edu_single.date_of_graduation" data-language="en">
														<span class="error-block" v-if="errors.date_of_graduation" v-for="error in errors.date_of_graduation" v-text="error"></span>
													</div>
												</div>

												<div class="col-sm-4">
													<button type="button" class="add-btn add-edu" style="top: 0px;">Add</button>
												</div>
											</div>
											...
											<div class="w3-container main_side col-sm-12" style="height:100px;">
												<div style="width: 50%;float:left;" align="left">
													<button type="button" class="prev-btn" data-prev="personal_info">Previous</button>
												</div>
											...
											<div class="col-sm-12">
												...
												<div class="w3-container main_side col-sm-6" >
													...
													<div :class="(errors.native_language)?'form-group has_error':'form-group'">
														...
														<input type="text" name="native_language" class="form-control" v-model="qual.native_language">
												...
												<div class="w3-container main_side col-sm-12" style="height:100px;">
													<div style="width: 50%;float:left;" align="left">
														<button type="button" class="prev-btn" data-prev="educational_background">Previous</button>
													</div>
													<div style="width: 50%;float:left;" align="right">
														<button type="submit" class="next-btn">Done</button>
													</div>
									...
									<section class="financial">
										...
										<div class="w3-container w3-teal row">
											<div class="col-sm-12">
												...
												<div class="w3-container main_side col-sm-12" style="height:100px;">
													<div style="width: 50%;float:left;" align="left">
														<button type="button" class="prev-btn" data-prev="family_mem">Previous</button>
													</div>
													<div style="width: 50%;float:left;" align="right">
														<button type="submit" class="next-btn">Done</button>
													</div>
									...
									<section class="mailing">
										...
										<div class="w3-container w3-teal row">
											<div class="col-sm-12">
												...
												<div class="row">
													<div class="w3-container main_side col-sm-6">
														...
														<div :class="(errors.name)?'form-group has_error':'form-group'">
															...
															<input type="text" name="name" class="form-control" v-model="mailing.name">
														...
														<div :class="(errors.tel)?'form-group has_error':'form-group'">
															...
															<input type="text" name="tel" class="form-control" v-model="mailing.tel">
															<span class="error-block" v-if="errors.tel" v-for="error in errors.tel" v-text="error"></span>
														</div>
														...
														<div :class="(errors.phone)?'form-group has_error':'form-group'">
															<label class="label__control">Cell Phone
																<span class="label__required">*</span></label>
															<input type="text" name="phone" class="form-control" v-model="mailing.phone">
															<span class="error-block" v-if="errors.phone" v-for="error in errors.phone" v-text="error"></span>
														</div>
														...
														<div :class="(errors.building)?'form-group has_error':'form-group'">
															...
															<span class="label__required">*</span></label>
															<input type="text" name="building" class="form-control" v-model="mailing.building">
													...
													<div class="w3-container main_side col-sm-6" >
														...
														<div :class="(errors.street)?'form-group has_error':'form-group'">
															...
															<span class="label__required">*</span></label>
															<input type="text" name="street" class="form-control" v-model="mailing.street">
														...
														<div :class="(errors.city)?'form-group has_error':'form-group'">
															...
															<span class="label__required">*</span></label>
															<input type="text" name="city" class="form-control" v-model="mailing.city">
														...
														<div :class="(errors.country)?'form-group has_error':'form-group'">
															...
															<input type="text" name="country" class="form-control" v-model="mailing.country">
														...
														<div :class="(errors.postcode)?'form-group has_error':'form-group'">
															...
															<span class="label__required">*</span></label>
															<input type="text" name="postcode" class="form-control" v-model="mailing.postcode">
												...
												<div class="w3-container main_side col-sm-12" style="height:100px;">
													<div style="width: 50%;float:left;" align="left">
														<button type="button" class="prev-btn" data-prev="financial">Previous</button>
													</div>
													<div style="width: 50%;float:left;" align="right">
														<button type="submit" class="next-btn">Done</button>
													</div>
									...
									<section class="declaration">
										...
										<div class="w3-container w3-teal row">
											<div class="col-sm-12">
												...
												<div class="w3-container main_side col-sm-12" style="height:100px;">
													<div style="width: 50%;float:left;" align="left">
														<button type="button" class="prev-btn" data-prev="mailing">Previous</button>
													</div>
													<div style="width: 50%;float:left;" align="right">
										...
										<div class="w3-container w3-teal row">
											<div class="col-sm-12">
												...
												<div class="w3-container main_side col-sm-12"  align="left">
													...
													<input type="hidden" value="<?php echo e($data->university->id); ?>" name="university_id">
													...
													<div class="row" style="margin:20px 0px;"> 
				                                    	...
				                                    	<div class="form-group col-sm-4">
							                                <div class="image-placeholder" data-input="f-hidden-highest_education" data-preview="f-holder-highest_education" style="padding: 0px;">
							              						<img :src="(uploads.highest_education=='')?'<?php echo e(asset('placeholder.jpg')); ?>':uploads.highest_education" id="f-holder-highest_education" alt="university page" class="img-responsive img-selection img-thumbnail" style="max-height: 100%;max-width:100%;">
							                                </div>
													...
													<div class="row" style="margin:20px 0px;"> 
				                                    	...
				                                    	<div class="form-group col-sm-4">
							                                <div class="image-placeholder" data-input="f-hidden-medical_report" data-preview="f-holder-medical_report" style="padding: 0px;">
							              						<img :src="(uploads.medical_report=='')?'<?php echo e(asset('placeholder.jpg')); ?>':uploads.medical_report" id="f-holder-medical_report" alt="medical report" class="img-responsive img-selection img-thumbnail" style="max-height: 100%;max-width:100%;">
							                                </div>
													...
													<div class="row" style="margin:20px 0px;"> 
				                                    	...
				                                    	<div class="form-group col-sm-4">
							                                <div class="image-placeholder" data-input="f-hidden-passport" data-preview="f-holder-passport" style="padding: 0px;">
							              						<img :src="(uploads.passport)?uploads.passport:'<?php echo e(asset('placeholder.jpg')); ?>'" alt="passport report" id="f-holder-passport" class="img-responsive img-selection img-thumbnail" style="max-height: 100%;max-width:100%;">
							                                </div>
													...
													<div class="row" style="margin: 20px 0px;" v-for="(other,key) in uploads.other">
				                                    	...
				                                    	<div class="form-group col-sm-4">
							                                <div class="image-placeholder" :data-input="'f-hidden-other'+key" :data-preview="'f-holder-other'+key" style="padding: 0px;" >
							              						<img :src="(uploads.other[key])?uploads.other[key]:'<?php echo e(asset('placeholder.jpg')); ?>'" :id="'f-holder-other'+key" alt="university page" class="img-responsive img-selection img-thumbnail" style="max-height: 100%;max-width:100%;;">
							                                </div>
													...
													<div class="w3-container main_side col-sm-12" style="height:100px;">
														<div style="width: 50%;float:left;" align="left">
															<button type="button" class="prev-btn" data-prev="declaration">Previous</button>
														</div>
														<div style="width: 50%;float:left;" align="right">
															<button type="submit" class="next-btn">Done</button>
														</div>
									...
									<section class="submit">
										<div class="w3-container w3-teal row">
											...
											<div class="w3-container main_side col-sm-12" style="height:100px;">
												<div style="width: 50%;float:left;" align="left">
													<button type="button" class="prev-btn" data-prev="payment">Previous</button>
												</div>
												<div style="width: 50%;float:left;" align="left">
													<button type="submit" class="next-btn">Done</button>
												</div>
	...
	<script>
		var application_form = new Vue({
            ...
            created(){
            	...
            	this.countries = <?php echo pluckCountry(); ?>;
            	<?php if(isset($app->personal_information) && $app->personal_information !== null): ?>
        			this.personal_info = JSON.parse('<?php echo $app->personal_information; ?>');
        			this.status.pi = 1;
            	<?php endif; ?>
            	<?php if(isset($app->educational_background) && $app->educational_background !== null): ?>
        			this.edu = JSON.parse('<?php echo $app->educational_background; ?>');
        			this.status.eb = 1;
            	<?php endif; ?>
            	<?php if(isset($app->language_qualification) && $app->language_qualification !== null): ?>
        			this.qual = JSON.parse('<?php echo $app->language_qualification; ?>');
        			this.status.lq = 1;
            	<?php endif; ?>
            	<?php if(isset($app->reasons_to_choose) && $app->reasons_to_choose !== null): ?>
        			// this.reason_to_choose = '<?php echo e(($app->reasons_to_choose)??''); ?>';
        			// this.status.rtc = 1;
            	<?php endif; ?>
            	<?php if(isset($app->family) && $app->family !== null): ?>
        			// this.family_mem = JSON.parse('<?php echo $app->family; ?>');
        			// this.status.fm = 1;
            	<?php endif; ?>
            	<?php if(isset($app->financial_support) && $app->financial_support !== null): ?>
        			this.financial = JSON.parse('<?php echo $app->financial_support; ?>');
        			this.status.fs = 1;
            	<?php endif; ?>
            	<?php if(isset($app->mailling_address) && $app->mailling_address !== null): ?>
        			this.mailing = JSON.parse('<?php echo $app->mailling_address; ?>');
        			this.status.ma = 1;
            	<?php endif; ?>
            	<?php if($current == 1): ?>
            		<?php if(isset($app->declaration)): ?>
	        			this.declaration = '<?php echo $app->declaration; ?>'*1;
        				this.status.dec = '<?php echo $app->declaration; ?>'*1;
	            	<?php endif; ?>
            	<?php endif; ?>
            	<?php if(isset($app->uploads) && $app->uploads !== null): ?>
        			this.uploads = JSON.parse('<?php echo $app->uploads; ?>');
        			this.status.ud = 1;
            	<?php endif; ?>
            	<?php if(isset($app->application_fee) && $app->application_fee !== null): ?>
        			// this.payment = '<?php echo $app->application_fee; ?>'*1;
        			// this.status.pay = this.payment;
            	<?php endif; ?>
        		$(document).ready(function(){
        			<?php if(isset($_GET['check'])): ?>
        				setTimeout(function(){
    						$('div[data-tab="<?php echo e($_GET['check']); ?>"]').trigger('click');
	        			},1000);
        			<?php endif; ?>
        		});
            },
                ...
                $('.datepicker-autoclose').datepicker({
              	...
              	$(document).on('submit', '.form_submit', function(e){
					...
					// }
              		...
              		axios
              		.post('<?php echo e(url("apply-validation")); ?>', {data:data, _token:'<?php echo e(csrf_token()); ?>', 'type':current, 'course_id':'<?php echo e($data->id); ?>', 'university_id':'<?php echo e($data->university->id); ?>'})
              		.then(response=>{
              			...
              			if(response.data.errors){
              				...
              				if(current=='submit'){
              					window.location.href = "<?php echo e(url('dashboard#application')); ?>";
              				}
              	...
              	$(document).on('submit', '.upload-documents-form', function(e){
              		...
              		axios
              		.post('<?php echo e(url('apply-validation')); ?>', data)
              		.then(response => {
              			if(response.data.errors){
              				_this.errors = response.data.errors;
              			}else{
