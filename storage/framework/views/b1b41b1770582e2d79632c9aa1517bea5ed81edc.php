...
<div class="container">
    <div class="accordion" id="accordionExample">
                    ...
                    <?php $count_accordion_browse_home = 0; ?>
                        ...
                        <div class="card">
            <div class="card-header1" style="background: #0B6D76;" data-toggle="collapse" data-target="#collapse<?php echo $count_accordion_browse_home; ?>" aria-expanded="<?php if($count_accordion_browse_home == 1) { echo 'true'; } else { echo 'false'; } ?>">     
                <?php echo ($ser['title'])??''; ?>
            ...
            <div id="collapse<?php echo $count_accordion_browse_home; ?>" class="collapse <?php if($count_accordion_browse_home == 1) { echo 'show'; } ?>" data-parent="#accordionExample">
                <div class="card-body Selectone" style="border: none; margin-top: 10px;">

  <p><?php echo ($ser['text'])??''; ?></p>
...
<!-- /* ..................Browse Courses Section End............. */ -->
    ...
    <div class="container-fluid" style="padding: 0px !important;">
        ...
        <div class="<?php echo e(($meta['class'])??''); ?>" id="student_main_search">
            

            <div class="bg-light pt-3 pt-lg-5" id="student_main_search">
                <div class="row">
                    <section class="d-lg-none text-right mb-3">
                        <button  class="btn btn-primary filterBtn">
                            <i class="fa fa-filter"></i> Filter
                        </button>
                    </section>

                    <div class="col-md-12 search-filter container" style="display: block; margin: 25px; flex: auto !important;">
                        <form action="javascript:void(0);" id="DesktopFilter" class="card u-boxShadow-light l-labelList p-3 mb-3">
                           
                            <div class="row">
                                
                                 <div class="col-md-4 fieldset" style="margin-top:20px;">
                            ...
                            <div class="col-md-4 fieldset" style="margin-top:20px;">
                                ...
                                <select name="type" class="custom-select w-100 mb-3 inputtype type-select" style="
border: 1px solid #ccc;
border-radius: 0.25rem;
" v-model="location" @change="countrySelected()">
...
">
                            ...
                            <div class="fieldset dsp-0 show-uni" style="margin-top:20px;">
                                ...
                                <select name="university" class="custom-select select2 w-100 mb-3 university-select">
                            ...
                            <div class="fieldset dsp-0 show-sub" style="margin-top:20px;">
                                ...
                                <select name="country" class="custom-select select2 w-100 mb-3 subject-select">
                            ...
                            <div class="see-more" style="display: none !important;">
                            ...
                            <p class="see-more-btn" v-text="(allFilters*1==1)?'See Less':'See More'"></p>
                        </form>
                    </div>

                    <div class="col-md-12 container" style="display: block; margin: 25px; flex: auto !important;">
                        ...
                        <div class="uni_lists type_uni">
                            ...
                            <section class="mb-3">
                                <div class="row " v-if="(universities.data && universities.data.length>0)">
                                    <div class="col-md-3 col-sm-12 col-xs-12" v-for="uni in universities.data">
                                        ...
                                        <article class="row  no-gutters align-items-center flex-nowrap border-bottom border-top u-small95 pt-4 course-articles" onerror="if(this.src!='<?php echo e(url(iph())); ?>'){this.src='<?php echo e(url(iph())); ?>'}" >
                                            ...
                                            <a :href="baseUrl+'/university/'+uni.slug" target="_blank">
                                            <img class="img-fluid" style="height: 200px;" :src="''+baseUrl+'/'+optImage(uni.logo,'thumbs')+''">
                                             </a>

                                                <h6><a :href="baseUrl+'/university/'+uni.slug" v-text="uni.name" target="_blank"></a><div class="ml-2" style="display: inline;font-size: 13px;position: relative;top: -1px;">({{uni.city}}, {{uni.country}})</div></h6>
                                        ...
                                        <br>
                                        <button class="col-md-12 btn btn-success btn-sm" style="margin-top: 5px;" onclick="send_emailcontat(this,'university')">Request information <i style="display: none;">'{{uni.id}}'</i></button>
                                        <button class="col-md-12 btn btn-success btn-sm" style="margin-top: 5px;" onclick="consulation()">Free Consultation</button>                   
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12" v-for="course in courses.data">
                                        <article class="row no-gutters align-items-center flex-nowrap border-bottom border-top u-small95 pt-4 course-articles">
                                            <div class="col search-grad" style="text-align: center;">
                                                ...
                                                <img class="img-fluid" style="height: 200px;" :src="(course.university)?''+baseUrl+'/'+optImage(course.university.logo,'thumbs')+'':''">
                                                </a>

                                                <h6><a :href="baseUrl+'/courses/'+course.id" v-text="course.name" target="_blank"></a><div class="ml-2" style="display: inline;font-size: 13px;position: relative;top: -1px;" v-if="course.qualification_name">({{course.qualification_name.title}})</div></h6>
                                                <div class="media mb-3">
                                                    <div class="media-body mx-2">
                                                        <div class="text-muted small">
                                                            <div class=""><i class="fa fa-university"></i> {{course.university.name}} <div style="display: inline;font-size: 11px;position: relative;top: -1px;color: #c52228;" v-if="course.university">({{course.university.city}} ,{{course.university.country}})</div></div>
                                                            ...
                                                            <button style="margin-top:10px;" class="btn btn-success btn-sm col-md-12" onclick="send_emailcontat(this,'course')">Request information <i style="display: none;">'{{course.id}}'</i></button> 
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12" v-for="guide in guides.data">
                                        <article class="row no-gutters align-items-center flex-nowrap border-bottom border-top u-small95 pt-4 course-articles">
                                            <div class="col search-grad" style="text-align: center;">
                                                ...
                                                <img class="img-fluid" style="height: 200px;" :src="(guide.university_id!==null)?''+baseUrl+'/'+optImage(guide.university.logo,'thumbs')+'':''">
                                                </a>
                                                ...
                                                <div class="media mb-3">
                                                    <div class="media-body mx-2">
                                                        <div class="text-muted small">
                                                            <div class="" v-if="guide.university_id!==null"><i class="fa fa-university"></i> {{guide.university.name}} <div style="display: inline;font-size: 11px;position: relative;top: -1px;color: #c52228;" v-if="guide.university">({{guide.university.city}} ,{{guide.university.country}})</div></div>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12" v-for="article in articles.data">
                                        <article class="row no-gutters align-items-center flex-nowrap border-bottom border-top u-small95 pt-4 course-articles img_cover">
                                            <div class="col search-grad" style="text-align: center;">
                                                ...
                                                <img class="img-fluid" style="height: 200px;" :src="''+baseUrl+'/'+optImage(article.image,'thumbs')+''">
                                                </a>
            ...
            <script>
                ...
                var content234 = new Vue({
                    ...
                    data: {
                        ...
                        page: 1,
                        limit: '<?php echo e(($meta['limit'])??14); ?>',
                        allFilters:0,
                        counter:1,
                    },
                    created(){
                    ...
                    methods: {
                        fetchData(page){
                            ...
                            window.history.pushState({path:'<?php echo e(request()->url()); ?>'+data},'','<?php echo e(request()->url()); ?>'+data);
                                ...
                                .then(response => {
                                    ...
                                    $(function(){
                                        if(_this.type == 'course'){
                                            ...
                                            $('.type_cou').fadeIn(200);
                                            $('.show-sub').fadeIn(300); $('.show-sch').fadeIn(300);
                                            $('.show-lan').fadeIn(300); $('.show-qua').fadeIn(300);
                                            $('.show-rat').fadeOut(300); $('.show-dur').fadeIn(300);
                                            $('.show-uni').fadeIn(300); $('.show-gui').fadeOut(300);
                                            $('.show-fee').fadeIn(300);
                                            ...
                                            $('.type_gui').fadeIn(200);
                                            $('.show-sub').fadeOut(300); $('.show-sch').fadeOut(300);
                                            $('.show-lan').fadeOut(300); $('.show-qua').fadeOut(300);
                                            $('.show-rat').fadeOut(300); $('.show-dur').fadeOut(300);
                                            $('.show-uni').fadeOut(300); $('.show-gui').fadeIn(300);
                                            ...
                                            $('.show-lan').fadeOut(300); $('.show-qua').fadeOut(300);
                                            $('.show-rat').fadeOut(300); $('.show-dur').fadeOut(300);
                                            $('.show-uni').fadeOut(300); $('.show-gui').fadeOut(300);
                                            $('.show-fee').fadeOut(300);
                                        }else{
                                            ...
                                            $('.type_uni').fadeIn(200);
                                            $('.show-sub').fadeOut(300); $('.show-sch').fadeIn(300);
                                            $('.show-lan').fadeIn(300); $('.show-qua').fadeIn(300);
                                            $('.show-rat').fadeIn(300); $('.show-dur').fadeOut(300);
                                            $('.show-uni').fadeOut(300); $('.show-gui').fadeOut(300);
                                            $('.show-fee').fadeOut(300);
                                        }
