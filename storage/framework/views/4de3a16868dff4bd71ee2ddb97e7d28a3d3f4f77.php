                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 file-input-column">
                    <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                        <label class="form__label dashboard-form-label">Enter Your Name<span class="label__required">*</span>
                          ...
                          <input type="text" name="name" required class="form-control" placeholder="Your Name"  value="<?php echo e($user->name); ?>">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 file-input-column">
                    <div class="form-group<?php echo e($errors->has('passport_number') ? ' has-error' : ''); ?>">
                        <label class="form__label dashboard-form-label">Passport Number</label>
                          <input type="text" name="passport_number" required class="form-control" placeholder="Passport Number" value="<?php echo e($user->passport_number); ?>">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 file-input-column">
                    <div class="form-group<?php echo e($errors->has('course_doc') ? ' has-error' : ''); ?>">
                        <label class="form__label dashboard-form-label">Course<span class="label__required">*</span>
                          ...
                          <input type="text" name="course_doc" required class="form-control" placeholder="Course" value="<?php echo e($user->course_doc); ?>">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 file-input-column">
                    <div class="form-group<?php echo e($errors->has('intrested_country_doc') ? ' has-error' : ''); ?>">
                        <label class="form__label dashboard-form-label">Intrested Country</label>
                          <input type="text" name="intrested_country_doc" class="form-control" placeholder="Intrested Country" value="<?php echo e($user->intrested_country_doc); ?>">
