    ...
    multipleUser :function(options){
        ...
        if(settings.selector != ''){
            ...
            settings.users.forEach(function (user, index){
                ...
                userList +='<li onclick="event_trigger_web(\'whatsapp_button\', \''+settings.users[index].name+'\')" class="ayoan_item rs-go-to-whatsapp '+active+'" data-userId="'+index+'">'+
                    '<div class="col ayoan_col-1"><div class="user-pro-pic-wrapper">'+
                    '<img class="user-pro-pic" src="'+image+'" style="width:50px"></div></div><div class="col ayoan_col-2">'+
                    '<div class="ayoan_list-title">'+settings.users[index].name+'</div><div class="ayoan_list-content">'+designation+'</div>'+
                    '<div class="list-latest-text"></div></div><div class="col ayoan_col-3"><div class="list-icon-wrapper">'+
            ...
            if(element !=null){
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container">' +
                    ...
                    '<button type="button" class="rs-close widget-close-btn whatsapp_floating_trigger">' +
                    '<svg class="icon whatsapp_floating_trigger" version="1.0" xmlns="http://www.w3.org/2000/svg" width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet"> <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#fff" stroke="none"> <path d="M167 5104 c-66 -20 -131 -88 -152 -157 -19 -64 -19 -90 1 -158 15 -53 42 -81 1102 -1141 l1087 -1088 -1087 -1087 c-1060 -1061 -1087 -1089 -1102 -1142 -20 -68 -20 -94 0 -160 28 -96 131 -171 234 -171 20 0 59 7 86 16 45 15 139 106 1136 1103 l1088 1086 1088 -1086 c1038 -1038 1089 -1088 1141 -1104 121 -39 242 12 304 129 30 58 30 155 -2 216 -16 32 -342 364 -1099 1122 l-1077 1078 1077 1078 c740 741 1083 1090 1097 1119 28 56 36 118 22 169 -38 141 -176 220 -317 179 l-59 -17 -1088 -1086 -1087 -1087 -1088 1087 c-1061 1060 -1088 1087 -1141 1102 -66 19 -101 19 -164 0z"/></g> </svg></button></div></div>' +
                    '<div class="rs-openChatBtn widget-close-btn-row whatsapp_floating_trigger" >' +
                    '<button type="button" class="rs-openChatBtn widget-close-btn whatsapp_floating_trigger">' +
                    '<span calss="notification-span">1</span>'+
                    '<div class="message-box">' +
                    '<div class="message">How may I help you?</div>'+
                    '</div>'+
                    '<svg class="icon whatsapp_floating_trigger" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"><g> <path d="M378.853,294.202c-0.997-0.479-38.324-18.859-44.956-21.246c-2.708-0.972-5.609-1.922-8.694-1.922 c-5.04,0-9.274,2.512-12.572,7.446c-3.729,5.542-15.016,18.736-18.503,22.678c-0.456,0.52-1.077,1.142-1.45,1.142 c-0.334,0-6.111-2.379-7.86-3.138c-40.041-17.393-70.433-59.219-74.601-66.272c-0.595-1.014-0.62-1.474-0.625-1.474 c0.146-0.537,1.493-1.887,2.188-2.583c2.033-2.011,4.236-4.663,6.367-7.228c1.009-1.215,2.02-2.432,3.012-3.579 c3.092-3.597,4.468-6.39,6.064-9.625l0.836-1.681c3.897-7.742,0.569-14.274-0.507-16.384c-0.883-1.765-16.643-39.803-18.319-43.799 c-4.03-9.643-9.354-14.133-16.753-14.133c-0.687,0,0,0-2.879,0.121c-3.506,0.148-22.598,2.661-31.039,7.983 c-8.952,5.644-24.096,23.633-24.096,55.271c0,28.474,18.07,55.359,25.828,65.584c0.193,0.258,0.547,0.781,1.061,1.533 c29.711,43.39,66.75,75.547,104.297,90.546c36.148,14.439,53.265,16.108,62.996,16.108c0.002,0,0.002,0,0.002,0 c4.089,0,7.362-0.321,10.25-0.605l1.832-0.175c12.487-1.107,39.929-15.327,46.171-32.673c4.917-13.663,6.214-28.591,2.942-34.008 C387.604,298.403,383.742,296.549,378.853,294.202z" style="fill: #fff"></path><path d="M260.545,0C121.879,0,9.066,111.965,9.066,249.588c0,44.512,11.912,88.084,34.479,126.218 L0.352,503.216c-0.805,2.375-0.206,5.002,1.551,6.791C3.172,511.302,4.892,512,6.649,512c0.673,0,1.351-0.101,2.013-0.313 l132.854-42.217c36.355,19.424,77.445,29.678,119.03,29.678C399.199,499.15,512,387.197,512,249.588 C512,111.965,399.199,0,260.545,0z M260.545,447.159c-39.13,0-77.029-11.299-109.608-32.677c-1.095-0.72-2.367-1.089-3.647-1.089 c-0.677,0-1.355,0.103-2.015,0.313l-66.552,21.155l21.484-63.383c0.695-2.051,0.347-4.314-0.933-6.063 c-24.809-33.898-37.923-73.949-37.923-115.827c0-108.955,89.357-197.597,199.191-197.597c109.821,0,199.168,88.642,199.168,197.597 C459.713,358.53,370.367,447.159,260.545,447.159z" style="fill: #fff;"></path></g></svg></button></div></div>';
...
function changeColor(color){
    ...
    var listIcon = document.querySelectorAll(".ayoan_whatsapp_chatbox .widget-body .body-content .user-list .ayoan_item.active .ayoan_col-3 .list-icon-wrapper .list-icon path");
...
function sendWPMessage(phone, message='welcome'){
   var isMobileTrue = isMobile();
    ...
    // }
    apiEndPoint = apiEndPoint+'api';
    apiEndPoint = apiEndPoint+'.whatsapp.com/send?phone=' + phone;
    if (link) {
        apiEndPoint += '&text=' + encodeURIComponent(link);
    }
      else {
        apiEndPoint += '&text=' + encodeURIComponent(message);
    }
      if (isMobile) {
        // For mobile devices, use window.location.href to open in the same tab
        window.location.href = apiEndPoint;
    } else {
        // For non-mobile devices, use window.open
